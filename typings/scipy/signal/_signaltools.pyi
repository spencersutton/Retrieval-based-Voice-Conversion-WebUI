...
def correlate(
    in1, in2, mode=..., method=...
):  # -> NDArray[complex128] | Any | NDArray[complexfloating[Any, Any]] | Array | NDArray[Any] | ndarray[_AnyShape, DType]:
    r"""
...
def fftconvolve(in1, in2, mode=..., axes=...):  # -> Any:
...
def oaconvolve(in1, in2, mode=..., axes=...):  # -> Any:
...
def choose_conv_method(
    in1, in2, mode=..., measure=...
):  # -> tuple[Literal['fft', 'direct'], dict[Any, Any]] | Literal['direct', 'fft']:
    """
...
def convolve(
    in1, in2, mode=..., method=...
):  # -> NDArray[complexfloating[Any, Any]] | Any | Array | NDArray[complex128] | NDArray[Any] | ndarray[_AnyShape, DType]:
    """
...
def wiener(im, mysize=..., noise=...):  # -> Any:
    """
...
def deconvolve(
    signal, divisor
):  # -> tuple[scipy._lib.array_api_compat.numpy._typing.Array | Any | tuple[scipy._lib.array_api_compat.numpy._typing.Array | Any, scipy._lib.array_api_compat.numpy._typing.Array | Any] | list[Any], scipy._lib.array_api_extra._lib._utils._typing.Array | Any]:
...
def invres(
    r, p, k, tol=..., rtype=...
):  # -> tuple[Any | Literal[0], NDArray[Any] | NDArray[numpy.bool[builtins.bool]]]:
...
def residue(
    b, a, tol=..., rtype=...
):  # -> tuple[_Array[tuple[()], float64], NDArray[Any], NDArray[Any]] | tuple[Any, NDArray[complexfloating[Any, Any]] | NDArray[floating[Any]], _Array1D[float64] | NDArray[floating[Any]]]:
...
def residuez(
    b, a, tol=..., rtype=...
):  # -> tuple[_Array[tuple[()], float64], NDArray[Any], NDArray[Any]] | tuple[Any, NDArray[complexfloating[Any, Any]] | NDArray[floating[Any]], ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[floating[Any]]]]:
...
def invresz(
    r, p, k, tol=..., rtype=...
):  # -> tuple[Any, NDArray[Any] | NDArray[numpy.bool[builtins.bool]]]:
...
):  # -> tuple[Any | tuple[Dispatchable], Any] | Any | tuple[Dispatchable]:
...
def resample_poly(x, up, down, axis=..., window=..., padtype=..., cval=...):  # -> Any:
    """
...
def sosfilt(
    sos, x, axis=..., zi=...
):  # -> tuple[Array | Any, Array | Any] | Array | Any:
    """
...
def sosfiltfilt(sos, x, axis=..., padtype=..., padlen=...):  # -> Any:
    """
